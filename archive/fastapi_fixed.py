#!/usr/bin/env python3
"""
Fixed FastAPI app for Python 3.14 alpha compatibility
Bypasses Pydantic type inference issues
"""
...
def create_fixed_fastapi_app():
    """Create a FastAPI app that works with Python 3.14 alpha."""
    try:
        # Import FastAPI with minimal dependencies
